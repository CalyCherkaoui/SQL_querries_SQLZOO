...
the game table. We can look up information about game 1012 by finding that row in the
game table.
...
/* 7 - List the player for every goal scored in a game where the stadium was 'National 
Stadium, Warsaw'*/
...
HINT
Select goals scored only by non-German players in matches where GER was the id of
 either team1 or team2.
